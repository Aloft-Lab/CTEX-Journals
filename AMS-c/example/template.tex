...
\MRClassification{MR分类号1, MR分类号2}

\ChineseClassification{此处填写中图分类号}
...
\EMRClassification{MR Classification1, MR Classification2}

\EChineseClassification{Write Chinese Classification here}
