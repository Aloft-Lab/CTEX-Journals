...
the second author is supported by \ldots (Grant No. \ldots)}}                  %%%   the Fund which you are supported by  %%%
...
\begin{theorem}[\cite{ref2}]\label{th:1.1} %Theorem 1.1 could be recalled by using Theorem \ref{th:1.1}
...
\acknowledgements{\rm Thanks \ldots}



\begin{thebibliography}{99}

\bibitem{ref1} %% Journals %% surname(s), initial(s), article, journal, volume, relevant page numbers, year
Lorenzini, D., Tucker, T. J.: The equations and the method of
Chabauty--Coleman. \emph{Invent. Math.}, \textbf{148}, 1--46
(2002)

\bibitem{ref2} %% Books %% surname(s), initial(s), title, publisher, place of publication, year
